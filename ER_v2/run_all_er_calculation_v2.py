...
import math
import json
from ER_v2.utils_ER_v2 import DFGConstructor, ERCalculator, GraphVisualizer
import os

# Create necessary directories
# os.makedirs('results/er_metrics_with_end_count', exist_ok=True)
# results_folder = 'results/er_metrics_with_end_count'
# results_folder = 'results/er_metrics_v1.1/dfg_visualization'
results_folder = 'results/er_metrics_v2/'
