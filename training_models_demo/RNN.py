...
def main(args):
    ...
    def objective(trial):
        ...
        wandb.init(
            project="PMF_benchmark_RNN-interpolate-7d",
            entity="yongboyu",
            config=config,
            group="RNN-optimization"
        )
    ...
    study = optuna.create_study(
        direction="minimize",
        study_name="RNN-optimization-interpolate-7d",
    ...
    forecast.to_csv(f'../output/result_interpolate_7d/{dataset}/RNN_predictions.csv')
    pdf_path = f'../output/result_interpolate_7d/{dataset}/RNN_predictions.pdf'
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train RNN (Demo).")
    parser.add_argument(
