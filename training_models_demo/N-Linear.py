...
def main(args):
    ...
    def objective(trial):
        ...
        wandb.init(
            project="PMF_benchmark_NLinear-interpolate-7d",
            entity="yongboyu",
            config=config,
            group="NLinear-optimization"
        )
    ...
    study = optuna.create_study(
        direction="minimize",
        study_name="NLinear-optimization-interpolate-7d",
    ...
    forecast.to_csv(f'../output/result_interpolate_7d/{dataset}/NLinear_predictions.csv')

    pdf_path = f'../output/result_interpolate_7d/{dataset}/NLinear_predictions.pdf'
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train N-Linear (Demo).")
    parser.add_argument(
