...
def main(args):
    ...
    def objective(trial):
        ...
        wandb.init(
            project="PMF_benchmark_XGBoost-interpolate-7d",
            entity="yongboyu",
            config=config,
            group="XGBoost-optimization"
        )
    ...
    study = optuna.create_study(
        direction="minimize",
        study_name="XGBoost--interpolate-7d",
    ...
    forecast.to_csv(f'../output/result_interpolate_7d/{dataset}/XGBoost_predictions.csv')

    pdf_path = f'../output/result_interpolate_7d/{dataset}/XGBoost_predictions.pdf'
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train XGBoost (Demo).")
    parser.add_argument(
