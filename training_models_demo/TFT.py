...
def main(args):
    ...
    def objective(trial):
        ...
        wandb.init(
            project="PMF_benchmark_TFT",
            entity="yongboyu",
            config=config,
            group="TFT-optimization"
        )
    ...
    study = optuna.create_study(
        direction="minimize",
        study_name="TFT-optimization-20241203",
    ...
    forecast.to_csv(f'../output/result/{dataset}/TFT_predictions.csv')
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train Temporal Fusion Transformer (Demo).")
    parser.add_argument(
