...
def main(args):
    ...
    def objective(trial):
        ...
        wandb.init(
            project="PMF_benchmark_DLinear-interpolate-7d",
            entity="yongboyu",
            config=config,
            group="DLinear-optimization"
        )
    ...
    study = optuna.create_study(
        direction="minimize",
        study_name="DLinear-optimization-interpolate-7d",
    ...
    forecast.to_csv(f'../output/result_interpolate_7d/{dataset}/DLinear_predictions.csv')

    pdf_path = f'../output/result_interpolate_7d/{dataset}/DLinear_predictions.pdf'
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train D-Linear (Demo).")
    parser.add_argument(
